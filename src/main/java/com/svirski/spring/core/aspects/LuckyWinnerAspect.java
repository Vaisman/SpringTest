...
public class LuckyWinnerAspect {
    ...
    @Pointcut("(execution(* com.svirski.spring.core.services.BookingService.bookTicket(com.svirski.spring.core.models.User, com.svirski.spring.core.models.Ticket)) && args(user, ticket))")

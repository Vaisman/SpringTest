...
@ContextConfiguration(classes = {AppConfiguration.class, DataSourceConfiguration.class, DbSessionFactory.class, com.svirski.spring.core.configuration.TestAuditoriumConfiguration.class})
@Transactional
